...
** timeToPlayThrough -> timeToFinish, timeToRepeat -> timeToSoundFinished
and similar substituting "durs" or "sups" for "time" in the above replacements
** Time -> ATime (for "absolute time")
** evStart = evArc . _1, evEnd   = evArc . _2
retrie would be especially good for this
** museqsDiff -> museqSynthsDiff
* TODO mysteries
** TODO Can it be lazy?
