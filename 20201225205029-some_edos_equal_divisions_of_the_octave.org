...
*** DONE GOOD 12\58 x 5\58: 17-lim -7
    [ 0 steps; 1 % 1 ; string 0 ; fret 0
...
*** TODO 10\58 x 1\58: 17-lim, octave 6s -2f
    ...
    , 34 steps; 3 % 2 ; string 3 ; fret 4
    , 24 steps; 4 % 3 ; string 2 ; fret 4 -- lucky
    , 19 steps; 5 % 4 ; string 2 ; fret - 1
...
****** fills the holes really well
       ...
       40 steps; 11 % 8 ; string 2 ; fret 3
** TODO 94-edo
*** Bosanquet (16 x 7) pairs well with
**** Pr.pPrint $ bestLayout' 31 94 19 9
     reason for being: easy 17, 23
     also great 7-limit +13
     [ 0 steps; 1 % 1 ; string 0 ; fret 0
