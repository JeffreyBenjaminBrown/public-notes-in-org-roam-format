...
https://docs.djangoproject.com/en/3.0/intro/tutorial04/
  53% of the way through, at the section called
...
** part 7: customize the admin form
 (unread)
* questions
** How to share text across templates?
For instance, what if I wanted to change the text "No polls are available."
in all templates at once?
* The "topic guides"
