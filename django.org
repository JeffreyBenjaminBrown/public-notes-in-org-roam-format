...
* TODO if Apache works in tax.co:new
then rename it and push it to Docker hub
* refs
** All Django documentation
 https://docs.djangoproject.com/en/3.1/
*** TODO [[file:20201006192557-using_apache_and_mod_wsgi_with_django.org][Using Apache and mod_wsgi with Django]]
