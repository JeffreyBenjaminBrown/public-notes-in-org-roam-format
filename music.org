...
:END:
#+title: music
* comparing Kite-34 and Kite-41
  p17_no7 = [1 % 1,2 % 1,3 % 2,5 % 4,9 % 8,11 % 8,13 % 8,15 % 8]
  myPrint $ map concat $ printLayout (p17_no7 ++ [17/16,23/16]) (show . numerator) 34 (11,2)
  myPrint $ map concat $ printLayout (p17_no7 ++ [7/4,19/16,29/16,31/16]) (show . numerator) 41 (13,2)
