...
* PITFALL: I disabled baloo
  ...
  and it still worked.
* TODO asking NixOS: Can't rebuild, unstable, bower-json broken.
** currently trying: rebuild without spago
** the link
   https://discourse.nixos.org/t/cant-rebuild-on-nixos-unstable-because-a-package-is-marked-as-broken-should-i-fix-it-or-ditch-it
