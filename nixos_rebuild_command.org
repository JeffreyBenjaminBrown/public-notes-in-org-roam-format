...
** how to do it
   ...
   # AWAITS : Is `nix-channel update` working, or should I run it here, before the above script, like before?
   # AWAITS : If the above works, commit the new rebuild-branches script.
