...
***** Org-style text.
***** Optional ID for what it comments on.
      Its comments are shown as a grandchild of what it comments on, mediated by the child "& private".
***** IDs for every node in it.
