...
* innovations truly in reach
** [[id:2cacb9e0-074a-4ae7-a889-b170a355923f][simple text tree graph relations]]
** Extract the punctuation one tends toward automatically.
   e.g. start with & and two words,
   using (path to) parent if absent
* goal
  Una app para compartir notas. Imagínate que puedas mirar algo escrito por alguien y cambiar su forma, creando tu propio lente hacia un tema, y puedes compartir también lentes, todo siendo la misma forma de información.

  Sería como social media, pero en vez de compartir cosas que desaparecen, juntos construiríamos nuestros mundos de ideas permanentes.
* refs
** on Github
...
* make knowable to the user
** [[id:2cacb9e0-074a-4ae7-a889-b170a355923f]["It, this and these" make tree relationships easy.]]
* Use pattern might be more important than medium.
  First take notes on what someone wrote.
  Then disperse them, carrying citations.
* Motivation: Shared note-taking is not yet feasible.
** citation would be immediate
* TODO conceptual
