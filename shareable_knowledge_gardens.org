...
*** [[id:9c5619e5-81ad-4a67-9705-e4761bdd6839::+title: shareable knowledge gardens (skg)][this file itself]]
    ...
    :END:
* Some graphs do not want to pollute what they link to
...
* unsorted
** Link content filters because, e.g., the ternary shows-because relationship.
*** the shows-because relationship
...
*** The ternary nature of the relationship can usually be disregarded.
...
** The pre-indendation, like the body, means "blocks children for reader".
*** [[id:93eeb370-9f9c-4375-957d-91aab39007ee][It's simpler than it looks.]]
...
*** herald 'u'?
** ~ should be 'is very fundamentall related to'
