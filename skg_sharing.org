...
* TODO mk_skgnode is wrong
  It sets a lot of SkgNode list fields to None.
* TODO 'overrides' might be unnecessary
...
* DONE on save, check that edits are only to owned repos
* later
