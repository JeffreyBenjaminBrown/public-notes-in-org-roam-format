...
** The proof, alas, does not fit in the margin of my spare time.
   ...
   But it's true. I've proved it numerous times, once without even using a computer, and some smart-seeming guy on one of the Xenharmonic music forums on Facebook said the same thing. I'm sure that would stand up in court.
